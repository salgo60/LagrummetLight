...
# Lagrummet Light 
* video [Sveriges digitala rättsmiss](https://github.com/salgo60/LagrummetLight/issues/19)
...
<img width="2752" height="1536" alt="image" src="https://github.com/user-attachments/assets/df4fab2a-9745-477c-9097-6096d6969553" />

Dagens [lagrummet.se](https://lagrummet.se/lagrummet/rattsinformation/myndigheters-foreskrifter) blev efter 21 år förminskat till några länkar. [SFS 1999:175](https://www.riksdagen.se/sv/dokument-lagar/dokument/svensk-forfattningssamling/rattsinformationsforordning-1999175_sfs-1999-175) anger att ett Rättsinformationssystem skall skapas vem som äger ansvaret verkar ingen veta https://github.com/salgo60/LagrummetLight/issues/3 senaste dokumenterade händelse vi hittat är [2016 dec 16](https://github.com/rinfo/rdl/commit/21131dde010476c7c090e85a4ec50fb4738fc261) dvs. 7 år sedan. Idag är det 26 år efter att [förstudien startades Ds 1998:10](https://web.archive.org/web/20220811093437/https://www.regeringen.se/49bb67/contentassets/32378143627e4b6da8e9e196773bedbe/ett-offentligt-rattsinformationssystem) som pekar på att Rättsosäkerhet råder och pekar på att några 1000 dokument skall samlas in från 100 myndigheter dvs. ett försök till [interoperabilitet mellan olika myndigheter](https://web.archive.org/web/20250815221105/https://community.dataportal.se/topic/599/interoperable-europe-act) som misslyckats även fast detta projekt var begränsat  _[Rättsinformationssystemet skall innehålla de gällande förordningar som kungörs i andra författningssamlingar än Svensk författningssamling](https://www.riksdagen.se/sv/dokument-lagar/dokument/svensk-forfattningssamling/rattsinformationsforordning-1999175_sfs-1999-175)..._
* ett försök att ta reda på vem som driver detta projekt idag 26 år efter att [förstudien starta](https://www.regeringen.se/49bb67/contentassets/32378143627e4b6da8e9e196773bedbe/ett-offentligt-rattsinformationssystem) se [fråga Regeringskansliet](https://github.com/salgo60/LagrummetLight/issues/3).

Visonen 1996 med lagrummet se [Ds 1998:10](https://www.regeringen.se/rattsliga-dokument/departementsserien-och-promemorior/1998/01/ds-199810/)([IA](https://web.archive.org/web/20220811093437/https://www.regeringen.se/49bb67/contentassets/32378143627e4b6da8e9e196773bedbe/ett-offentligt-rattsinformationssystem)) och [SFS 1999:175 Rättsinformationsförordning](https://www.riksdagen.se/sv/dokument-lagar/dokument/svensk-forfattningssamling/rattsinformationsforordning-1999175_sfs-1999-175)

Inom EU finns visionen att all rättsinformation skall kopplas ihop se Publications Office of the European Union - [video](https://www.youtube.com/watch?v=iFD9FM5O3A0) - se mer info [The European Legislation Identifier (ELI and ELI-DL) – Use cases and implementations](https://github.com/salgo60/Wikidata_riksdagen-corpus/blob/main/info/ELI%20ELI-DL.md) - **[Sverige lyser med sin frånvaro](https://github.com/salgo60/Wikidata_riksdagen-corpus/blob/1fe3e22c9adc28931a561534a52eec94c598b1ef/info/ELI%20ELI-DL.md#eli)** se fråga [Regeringskansliet #3](https://github.com/salgo60/LagrummetLight/issues/3)
...
> 14 [ELI](https://eur-lex.europa.eu/eli-register/about.html) shall guarantee cost-effective public access to reliable and up-to-date legislation and is subject to voluntary and gradual introduction. To this end:
>
...
# Intressanta siffror från DS 1998:10 vad kostar dagens tomteverkstad årligen bilaga 3 sidan 166 dvs. multiplicera detta med 22 år
...
* 2022 [SVAR Domstolsverket](https://github.com/salgo60/open-data-examples/issues/2#issuecomment-1175362343) författningar från myndigheter saknas i lagrummet.se
  * hur andra länder jobbar med att koppla ihop EU och lagar se [Norge, Finland, Danmark](https://web.archive.org/web/20250219143512/https://community.dataportal.se/topic/388/tema-linking-global-knowledge/10?_=1659329300880)
...
* Konstig skrivelse att trots inget levereras så ["Regeringen konstaterar att rättsinformationssystemet i allt väsentligt nu fungerar i enlighet med de intentioner regeringen gett uttryck för i rättsinformationsförordningen (1999:175)
  ...
  * **4.6 ....Svårigheter med gemensam märkningsstandard**
    *  _"Det är naturligtvis fortfarande ett starkt önskemål med ett system som gör det möjligt att söka i hela systemet från den gemensamma ingångssidan. Frågan är emellertid om det är realistiskt med ett decentraliserat system där varje organ som producerar rättsinformation också ansvarar för den egna informationen"_
       * **varför inte peka på vad som är fel....** det måste vara galet med **inkompetens i 100 myndigheter**, dålig projektledning, obefintlig förmåga att anställa folk när man hasar runt i 15 år för massa miljoner.... det vi ser nu med en annan misskött sektor kulturarvet är att dom utlyser tjänster för nya kompetenser men inga söker... tror vi är där redan idag med myndigheterna när nya [expertmyndigheten DIGG inte ens kan versionshantera sina dokument](https://github.com/salgo60/DiggUptime/issues/47)
       * _"Regeringskansliet, beslutade den 5 april 2000 att all information som skall ingå i rättsinformationssystemet i projektets andra del skulle märkas upp i märkningsspråket XML. "_
          ...
          * _"krävas mycket mer arbete än som hade förutsatts med att analysera informationen"_ det intressanta är att detta skrevs tror jag innan då EU prata om [ELI](https://eur-lex.europa.eu/eli-register/about.html) och att [koppla ihop alla Europas lagar](https://www.youtube.com/watch?v=BOB_Q7sh0xI) dvs. dagens vision är **100 ggr mer komplex att se vilken Turkisk lag som motsvarar våra utlämningslagar**
          * _"var att de verktyg som utnyttjades var alltför svåra att använda för att kunna tas i bruk på handläggarnivå."_ **läs 100 myndigheter kan inte bygga upp kompetens på 15 år** vi behöver **Digitala aktörer iform av Myndigheter - kan Google kan vi**
...
* **2008 nov** [Svenska rättsinformationssystemets dokumentmodell](http://akswnc7.informatik.uni-leipzig.de/dstreitmatter/archivo/rinfo.lagrummet.se/ns--2008--11--rinfo--publ/2020.06.10-211504/ns--2008--11--rinfo--publ_type=generatedDocu.html)
* **2009 dec 9** [gasar projektet upp och nyanställer](https://groups.google.com/g/lagennu-utveckling/c/u0tHWF5bykQ?pli=1) från [lagen.nu](https://lagen.nu/om/varfor)/[GITHUB](https://github.com/staffanm/lagen.nu/issues?q=is%3Aissue+)/ [twitter](https://twitter.com/staffanm) Stefan Malmgren se [presentation](https://www.slideshare.net/staffanmalmgren/teranvndning-av-rttsinformation-privata-initiativ) vid stiftelsen för rättsinformations konferens 2009-11-24, tema "Marknaden för återanvändning av rättsinformation - vidareutnyttjande och offentlighetsuttag" 
  * Staffans graduate theses "[Towards a theory of jurisprudential relevance ranking Using link analysis on EU case law](https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.397.3802&rep=rep1&type=pdf)" [IA](https://web.archive.org/web/20211206231542/http://blog.tomtebo.org/2011/09/13/towards-a-theory-of-jurisprudential-relevance-ranking/) och "[Legal information system and the semantic web](https://web.archive.org/web/20160824172252/http://blog.tomtebo.org/wp-content/uploads/2011/08/Legal_information_systems_and_the_Semantic_Web.pdf)"
...
* **2023 dec 08 OMSTART efter 25 år?** Diarienummer: Ju2023/02684 [Uppdrag om en säker och effektiv tillgång till rättsinformation](https://github.com/salgo60/LagrummetLight/issues/3#issuecomment-2120750629
  ...
  * enormt udda att nya uppdrag skapas när det borde vara en del av projektmodellen jmf tveksamt om DIGG har en projektmodell
